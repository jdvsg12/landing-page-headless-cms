                    ...
                    <div className="mt-6 space-y-2">
                        ...
                        {contact.email && (
                            <motion.button
                                ...
                                whileTap={{ scale: 0.98 }}
                                className="flex w-full items-center justify-center gap-2 bg-neutral-900 py-4 text-sm font-medium text-white transition-colors duration-300 hover:bg-neutral-800"
                            >
